...
%\documentclass[oneside,masters]{.config/PPGMAp}
%\documentclass[oneside,qualification]{.config/PPGMAp}
%Para a tese habilite:
\documentclass[oneside]{.config/PPGMAp}
...
%
\PPGMApcoord{Prof. Dr.}{Fulano}{Detal}
...
\usepackage{usr/pack-and-cmd} % preâmbulo em outro arquivo!
